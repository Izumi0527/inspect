      ...
      <section className="relative overflow-hidden px-6 pt-16 pb-24">
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link href="/docs">
                <Button
                  variant="outline"
                  size="lg"
                  className="border-2 border-gray-300 bg-white/80 backdrop-blur-sm hover:bg-white text-gray-700 px-8 py-4 text-lg font-semibold rounded-xl"
                >
                  查看文档
                </Button>
              </Link>
            ...
            {/* 测试账号提示 */}
            <div className="mt-8 p-4 bg-blue-50/80 backdrop-blur-sm rounded-xl border border-blue-200">
              <p className="text-sm text-blue-700 text-center">
                🔐 <strong>测试账号：</strong>用户名 <code className="bg-blue-100 px-2 py-1 rounded">admin</code>
      ...
      <section className="py-20 px-6">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="p-8 text-center bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">实时监控</h3>
            ...
            <Card className="p-8 text-center bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">自动巡检</h3>
              <p className="text-gray-600">
                智能巡检策略，自动化设备健康检查
              </p>
            </Card>
            ...
            <Card className="p-8 text-center bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">智能告警</h3>
              <p className="text-gray-600">
                多级告警规则，多渠道通知推送
              </p>
            </Card>
