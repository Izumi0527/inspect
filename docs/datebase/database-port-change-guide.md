...
# 检查端口监听
netstat -an | findstr "15500 26380"
...
if ($redisTest -eq "PONG") {
    Write-Host "✅ Redis 连接成功 (端口 26380)" -ForegroundColor Green
} else {
...
Write-Host "  Redis:      localhost:26380 -> container:6379" -ForegroundColor White
```
