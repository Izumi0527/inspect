...
class WebSocketNotifier:
    ...
    @staticmethod
    async def notify_device_status_change(device_id: int, status: str, **kwargs):
        """通知设备状态变更"""
        message = {
        ...
        logger.info(
            "Device status notification sent",
            device_id=device_id,
            status=status
        )
    
    @staticmethod
    async def notify_scan_progress(scan_id: str, progress: int, status: str, **kwargs):
        """通知扫描进度"""
        message = {
        ...
        logger.info(
            "Scan progress notification sent",
            scan_id=scan_id,
            progress=progress,
            status=status
        )
    ...
    @staticmethod
    async def notify_alert(alert_type: str, severity: str, message_text: str, **kwargs):
        """发送告警通知"""
        message = {
    ...
    @staticmethod
    async def notify_system_event(event_type: str, message_text: str, **kwargs):
        """发送系统事件通知"""
        message = {
            "type": MessageType.SYSTEM_STATUS,
            "data": {
    ...
    @staticmethod
    async def notify_user(user_id: str, notification_type: str, message_text: str, **kwargs):
        """发送用户个人通知"""
        message = {
    ...
    @staticmethod
    async def notify_alert_escalation(alert_id: str, from_level: str, to_level: str, 
