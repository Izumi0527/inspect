...
from src.services.alert.types import AlertSeverity, AlertStatus, Alert
from src.core.influxdb import record_user_activity

if TYPE_CHECKING:
    from src.services.alert.engine import AlertEngine
...
class AlertEscalationService:
    ...
    def _get_alert_engine(self):
        ...
        if self._alert_engine is None:
            from src.services.alert.engine import alert_engine  # noqa: WPS433
