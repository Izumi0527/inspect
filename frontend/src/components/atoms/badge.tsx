  ...
  'inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        outline: 'text-foreground border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg hover:bg-white dark:hover:bg-gray-800',
        ...
        glass: 'border-white/20 dark:border-gray-700/20 bg-white/20 dark:bg-gray-800/20 backdrop-blur-lg text-gray-700 dark:text-gray-300 hover:bg-white/30 dark:hover:bg-gray-700/30',
      },
      size: {
