...
export interface ReportsToolbarAction {
  key: string
  label: string
...
interface ReportsToolbarSearch {
  value: string
  placeholder: string
  ariaLabel: string
...
interface ReportsToolbarProps {
  search?: ReportsToolbarSearch
  filters?: React.ReactNode
  primaryActions?: ReportsToolbarAction[]
  secondaryActions?: ReportsToolbarAction[]
...
export const ReportsToolbar: React.FC<ReportsToolbarProps> = ({
  ...
  return (
    ...
    >
      {isStartLayout ? (
        <div
          data-testid="reports-toolbar-start-group"
        ...
        <div
          data-testid="reports-toolbar-end-group"
