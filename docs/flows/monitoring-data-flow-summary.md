...
| 设备状态 | `GET /monitoring/devices/status` | 所有设备状态 |
| 流量摘要 | `GET /traffic/summary` | 网络流量统计 |
| 告警统计 | `GET /alerts/statistics` | 告警汇总 |
...
1. ✅ **实时性** - 60秒自动轮询，支持 WebSocket 实时推送
